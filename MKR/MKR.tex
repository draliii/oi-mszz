...
nejlépe vidět na příkladu, spočítáme $5^{17}$ v $\mathbb{Z}_{27}$.
\begin{enumerate}
...
Př.: Řešte soustavu: $x \equiv 2 \mod 4$, $x \equiv 0 \mod 5$, $x \equiv 1 \mod
9$, $x \equiv 2 \mod 11$.
...
prvky, které při výpočtu prochází přes netriviální odmocninu z jedné. $L_n = \{
a \in \mathbb{Z}_n^*, a^{n-1} = 1, \text{a když } a^{t2^j} = 1, \text{pak }
